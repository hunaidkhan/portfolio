...
export const HeroSection = () => {
  return <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
    <div className="absolute inset-0" style={{ maskImage: 'linear-gradient(to bottom, transparent, black 10%, black 70%, transparent)' }}>
      ...
      {/* my own */}
      <HeroOrbit size={740} rotation={30}>
        <SparkleIcon className="size-20 text-emerald-300"></SparkleIcon>
      </HeroOrbit>
    </div>
    <div className="container">
      ...
      <div className="max-w-lg mx-auto">
        <h1 className="font-serif text-3xl md:text-5xl text-center mt-8 tracking-wide">Building Exceptional Software for Companies</h1>
        <p className="mt-4 text-center text-white/60 md:text-lg">
          I specialize in high-speed, high-quality code delivery with an emphasis on impeccable user experience combined with solid team play. Let's get on a call!
        </p>
      </div>
